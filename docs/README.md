...
See the service named `job` in the [`docker-stack-web-app.yml`](https://gitlab.com/psuapp/psu/tree/v1.0.1/tests/dockerfiles/docker-stack-web-app.yml) file, for a real use case.
